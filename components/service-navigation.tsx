...
export function ServiceNavigation({ category, service }: ServiceNavigationProps) {
  ...
  return (
    <div className="bg-footer py-4 pt-6 mt-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="flex items-center text-sm text-white/70">
          ...
          <ChevronRight className="h-4 w-4 mx-2" />
          <Link href={`/services/${category}`} className="hover:text-secondary">
